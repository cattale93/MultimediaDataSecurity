function [F1Map,CFADetected, F1] = get_map_CFA(imPath)
...
F1Map=im2bw(F1Map,graythresh(F1Map));

F1Map=imresize(double(F1Map),[1500,2000]);
F1Map(F1Map>0.1)=1;
F1Map(F1Map<0.1)=0;
...
for k=1:4
    F1Map=not(F1Map);
    F1Map=bwareaopen(F1Map,10000);
    a_old = F1Map;
end

F1Map=imfill(F1Map,'holes');
